...
public class InviteCenter extends Fragment implements OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tv.setText(R.string.title_invites);

        ViewGroup contentContainer = (ViewGroup) v.findViewById(R.id.container);
        LinearLayout bookmarksView = (LinearLayout) inflater.inflate(R.layout.detail_invite, null, false);
